...
def make_argparser():
    ...
    #CNmc20tuned_10v10star_scaled10v10
    ...
    parser.add_argument("--mean_var_file", type=str, default=None, help="Path to mean/var file for dataset rescaling")
    ...
    parser.add_argument("--model_type", type=str, default="cn", help="fc=fully connect, cn=CNN, fcn=fully CNN, res=ResNet, tr=transformer")
    parser.add_argument('--tuned', type=str2bool, default=True, help="if training, use tuned parameters for selected model")
    parser.add_argument("--output_type", type=str, default="mc", help="mc=multiclass, ml=multilabel, mo=multiout")
    parser.add_argument("--output_length", type=str, default="vec", help="vec=vector (final only), seq=sequence (every time step)")
