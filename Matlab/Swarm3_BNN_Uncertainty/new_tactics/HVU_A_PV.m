function [states] = HVU_A_PV(info)
    ...
    Def_v_spread = Def_vel_max-Def_vel_min; % velocity spread
    v = Def_vel_min+Def_v_spread.*rand(Def_num,1); % (Nx1)column vector of velocities (constant)
