function [states] = AuctionPro_D_PV(N_defender, N_attacker, Defender_v_max,do_plot,final_fraction,seed,accel,kill_range,rand_start, Def_motion)
    ...
    if rand_start
        ...
        theta = pi/2*rand(N_attacker,1); % "stardust" is default motion
    end
