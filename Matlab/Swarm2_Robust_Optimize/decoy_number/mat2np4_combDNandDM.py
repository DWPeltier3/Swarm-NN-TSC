...
for num_def in num_defs:
    for decoy_motion in decoy_motions:
...
filename=f'data_{num_att}v1C10_combDM.npz'
...
filename=f'mean_var_{num_att}v1C10_combDM.npz'
...
filename=f'mean_var_{num_att}v1C10_combDM.mat'
full_path = os.path.join(data_path, mean_var_folder, filename)
