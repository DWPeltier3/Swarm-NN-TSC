classdef TranslatorForAveragePooling2DLayer < nnet.internal.cnn.keras.LayerTranslator
...
% Copyright 2017-2020 The MathWorks, Inc.
    ...
    methods
        function NNTLayers = translate(this, LSpec, TranslateWeights, TranslateTrainingParams, UserImageInputSize)
            ...
            NNTLayers = { averagePooling2dLayer(PoolSize, 'Stride', Stride, 'Padding', Padding, 'PaddingValue', PaddingValue, 'Name', LayerName) };
        end
