classdef TranslatorForGlobalMaxPooling1DLayer < nnet.internal.cnn.keras.LayerTranslator
...
% Copyright 2021-2022 The Mathworks, Inc.
    ...
    methods
        function NNTLayers = translate(this, LSpec, TranslateWeights, TranslateTrainingParams, UserImageInputSize)
            % This layer performs downsampling by computing maximum across 
            % the time or spatial dimension of the input.
            % LSpec.KerasConfig
            % ans =
            %   struct with fields:
            %
            ...
            if hasKerasField(LSpec,'keepdims') && kerasField(LSpec,'keepdims')==1
                NNTLayers = { globalMaxPooling1dLayer('Name', Name) };
            else
                NNTLayers = { globalMaxPooling1dLayer('Name', Name),...
