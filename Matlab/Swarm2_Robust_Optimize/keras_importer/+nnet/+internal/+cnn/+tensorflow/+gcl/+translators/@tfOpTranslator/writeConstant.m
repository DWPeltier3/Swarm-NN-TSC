function code = writeConstant(this, node_def, MATLABOutputName, TFConstants) 
%
...
%   Copyright 2020-2023 The MathWorks, Inc.
    ...
    switch node_def.attr.dtype.type
        case 'DT_FLOAT'
            if ~isempty(node_def.attr.value.tensor.float_val) && prod(tensor_shape) == 1
                if iscell(node_def.attr.value.tensor.float_val)
                    f = node_def.attr.value.tensor.float_val{:};                   
                else
        ...
        case 'DT_STRING' 
            ...
            constName = TFConstants.addConstant(MATLABOutputName, f, 1); 
    ...
    code = "struct('value', " + code + ", 'rank', " + string(tensorndims) + ");";
end
