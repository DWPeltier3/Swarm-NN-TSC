function datagenloop(N_attacker, N_defender)
    ...
    %% Save data matricies
    if savemat
        % Dynamic folder path based on N_attacker and N_defender
        folderName = sprintf('%dv%d_r4800_c4_a10', N_attacker, N_defender);
